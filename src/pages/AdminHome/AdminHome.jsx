...
const AdminHomePage = () => {
  ...
  const calculateStats = (users) => {
    ...
    users.forEach((user) => {
      if (user.role === "student") {
        ...
        if (sem)
          stats.semesters[`${dept || "Unknown"}-Sem${sem}`] =
            (stats.semesters[`${dept || "Unknown"}-Sem${sem}`] || 0) + 1;
  ...
  return (
    <div className="admin-homepage">
      ...
      <section className="kpi-cards" style={{ color: "black" }}>
      ...
      <section className="user-management" style={{ color: "black" }}>
        ...
        <div className="users-table" style={{ color: "black" }}>
